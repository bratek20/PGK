...
class Program3D : public ShaderProgram {
    ...
    GLuint worldMatId;
    GLuint meshColorId;
    GLuint reverseNormalId;
    GLuint isInstancedId;
...
public:
    ...
    void applyInstanced(bool isInstanced);
    void applyNormalsReversed(bool hasNormalsReversed);
    void applyColor(const Color& c); 
    void applyTexture(GLuint texture);
    void applyNoiseTexture(GLuint texture);
};
